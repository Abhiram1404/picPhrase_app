...
def pred(path):
    ...
    # print(path)
    tokenizer = load(open(r'D:\Abhi\projects\picPhrase\picPhrase\generateCap\static\models\tokenizer.pkl', 'rb'))
    model = load_model(r'D:\Abhi\projects\picPhrase\picPhrase\generateCap\static\models\model.h5')
    max_length = 34
